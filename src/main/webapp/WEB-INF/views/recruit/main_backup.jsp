	...
	<div class="container">
			...
			<table id="user_info_detail_table">
				...
				<tr >
					<td>
						...
						<span>(${submitEducationInfo.schoolYear}년)</span><br>
						<span>${submitEducationInfo.division}</span>
					</td>
					<td>
						<span>경력</span>&nbsp
			...
			<table class="td1" id="educationTable">
				...
				<template class=educationTemp>
					<tr class="educationTr">
						<td>
							<c:if test="${education.eduSeq != null}">
		...
		<section class="career">
			...
			<table class="td1" id="careerTable">
				...
				<c:choose>
					<c:when test="${careers.size() > 0}">
						<c:forEach var="career" items="${careers}">
							<tr class="careerTr">
								<td>
									<c:if test="${career.carSeq != null}">
		...
		<section class="certificate">
			...
			<table class="td1" id="certificateTable">
				...
				<c:choose>
					<c:when test="${certificates.size() > 0}">
						<c:forEach var="certificate" items="${certificates}">
							<tr class="certificateTr">
								<td>
									<c:if test="${certificate.certSeq != null}">
					...
					<c:otherwise>
						<tr class="certificateTr">
							...
							<td>
								<input type="text" name="acquDate" id="acquDate" class="acquDate" value="${certificate.acquDate}" maxLength="7" placeholder="YYYY.MM">
							</td>
							<td>
								<input type="text" name="organizeName" id="organizeName" class="organizeName" value="${certificate.organizeName}">
							</td>
