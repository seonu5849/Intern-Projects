...
<body>
	<div class="container">
		<!--  action="/recruit/login.do" method="POST" accept-charset="UTF-8" -->
		<form class="loginForm">
			<table class="loginTable">
				...
				<tr>
					...
					<td>
						<input type="text" name="phone" id="phone" maxlength="11" placeholder=" '-' 를 제외하고 11자리를 입력"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
